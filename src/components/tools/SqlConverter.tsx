...
export default function SqlConverter() {
  ...
  const handleConvertSql = async () => {
    ...
    try {
      const response = await fetch(`${API_ENDPOINT}/sql-convert`, {
        method: 'POST',
        headers: {
  ...
  const handleGenerateMock = async () => {
    ...
    try {
      const response = await fetch(`${API_ENDPOINT}/sql-generate-mock`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSqlToSchema = async () => {
    ...
    try {
      const response = await fetch(`${API_ENDPOINT}/sql-to-schema`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
